...
<html lang="en">
<head>
    <title>Code coverage report for zapier-platform-schema/lib/functional-constraints/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">zapier-platform-schema/lib/functional-constraints/</a> index.js
    </h1>
    <div class='clearfix'>
...
const runFunctionalConstraints = (definition) =&gt; {
  return checks.reduce((errors, checkFunc) =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (errorsForCheck) {
