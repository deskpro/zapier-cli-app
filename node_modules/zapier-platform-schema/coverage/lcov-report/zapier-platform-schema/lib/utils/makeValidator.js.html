...
<html lang="en">
<head>
    <title>Code coverage report for zapier-platform-schema/lib/utils/makeValidator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">zapier-platform-schema/lib/utils/</a> makeValidator.js
    </h1>
    <div class='clearfix'>
...
const makeValidator = (mainSchema, subSchemas) =&gt; {
  const schemas = [mainSchema].concat(subSchemas || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
